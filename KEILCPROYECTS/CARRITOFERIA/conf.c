...
void CAR_LeftFront(void){
    GPIOA->ODR &=(0<<RightFront)|(0<<RightBack);
    GPIOA->ODR &=(0<<LeftBack);        
    GPIOA->ODR |=(1<<LeftFront);

}

void CAR_LeftBack(void){
    GPIOA->ODR &=(0<<RightFront)|(0<<RightBack);
    GPIOA->ODR &=(0<<LeftFront);            
    GPIOA->ODR |=(1<<LeftBack);

}


void CAR_RightFront(void){
    GPIOA->ODR &=(0<<LeftFront)|(0<<LeftBack);
    GPIOA->ODR &=(0<<RightBack);        
    GPIOA->ODR |=(1<<RightFront);

}

void CAR_RightBack(void){
    GPIOA->ODR &=(0<<LeftFront)|(0<<LeftBack);
    GPIOA->ODR &=(0<<RightFront);            
    GPIOA->ODR |=(1<<RightBack);
